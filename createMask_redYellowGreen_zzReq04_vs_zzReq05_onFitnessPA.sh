...
fitnessFromReq04="zzReq04_age+fit+age.fit+.feat/cluster_mask_zstat2.nii.gz"
paFromReq05="zzReq05_age+pa+age.pa.feat/cluster_mask_zstat2_cluster4removed.nii.gz"

# In the final image inputT0 will be red, inputT1 will be yellow, and their overlap will be green.
#inputT0=$1
#inputT1=$2
inputT0="${fitnessFromReq04}"
inputT1="${paFromReq05}"
echo ""
echo ""
...
#outputDir=$3
outputDir="./redYellowGreen-fitpaAcrossModels-20140825"
rm -fr ${outputDir} 
mkdir ${outputDir}
