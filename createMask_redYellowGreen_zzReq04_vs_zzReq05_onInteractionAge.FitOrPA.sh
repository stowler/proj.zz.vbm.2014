...
interactionFromReq04="zzReq04_age+fit+age.fit+.feat/cluster_mask_zstat3.nii.gz"
interactionFromReq05="zzReq05_age+pa+age.pa.feat/cluster_mask_zstat3_cluster1removed.nii.gz"

# In the final image inputT0 will be red, inputT1 will be yellow, and their overlap will be green.
#inputT0=$1
#inputT1=$2
inputT0="${interactionFromReq04}"
inputT1="${interactionFromReq05}"
echo ""
echo ""
...
#outputDir=$3
outputDir="./redYellowGreen-interactionAcrossModels-20140825"
rm -fr ${outputDir} 
mkdir ${outputDir}
